...
class pay_access_Screen(Tk):
    ...
    def use_credits(self):
        ...
        if self.have_choose != 1:
            self.button_credit_choose = Button(image=self.photoSelect_T,compound=TOP,command=self.use_credits,borderwidth=0,background='#F2F2F2')
            self.button_credit_choose.place(x=393,y=318)
            if self.have_choose == 2:
                self.button_card_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_card,borderwidth=0,background='#F2F2F2')
                self.button_card_choose.place(x=393,y=441)
            elif self.have_choose == 3:
                self.button_apple_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_apple,borderwidth=0,background='#F2F2F2')
                self.button_apple_choose.place(x=393,y=543)
            else:
                self.button_paypal_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_paypal,borderwidth=0,background='#F2F2F2')
                self.button_paypal_choose.place(x=393,y=623)
            self.have_choose =1
    def use_card(self):
        #choose button image
        if self.have_choose != 2:
            self.button_card_choose = Button(image=self.photoSelect_T,compound=TOP,command=self.use_card,borderwidth=0,background='#F2F2F2')
            self.button_card_choose.place(x=393,y=441)
            if self.have_choose == 1:
                self.button_credit_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_credits,borderwidth=0,background='#F2F2F2')
                self.button_credit_choose.place(x=393,y=318)
            elif self.have_choose == 3:
                self.button_apple_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_apple,borderwidth=0,background='#F2F2F2')
                self.button_apple_choose.place(x=393,y=543)
    ...
    def use_apple(self):
        if self.have_choose != 3:
            self.button_apple_choose = Button(image=self.photoSelect_T,compound=TOP,command=self.use_apple,borderwidth=0,background='#F2F2F2')
            self.button_apple_choose.place(x=393,y=543)
            if self.have_choose == 1:
                self.button_credit_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_credits,borderwidth=0,background='#F2F2F2')
                self.button_credit_choose.place(x=393,y=318)
    ...
    def use_paypal(self):
        if self.have_choose != 4:
            self.button_paypal_choose = Button(image=self.photoSelect_T,compound=TOP,command=self.use_paypal,borderwidth=0,background='#F2F2F2')
            self.button_paypal_choose.place(x=393,y=623)
            if self.have_choose == 1:
                self.button_credit_choose = Button(image=self.photoSelect_F,compound=TOP,command=self.use_credits,borderwidth=0,background='#F2F2F2')
                self.button_credit_choose.place(x=393,y=318)
    ...
    def __init__(self):
        ...
        self.buttonProf= Button(image=self.photoProf,compound=TOP,command=self.to_profile_page,borderwidth=0,background='#FFF')
        ...
        self.topblock=Label(image=self.payblock2,background='#FFF')
        self.topblock.place(x=40,y=62)
        #text: bill
        self.bill_left = Label(text="amount:\nservice fee:\ndiscount:",font=(font_name,16),background='#F2F2F2',anchor="w")
        ...
        """
        str_fee = str("50\n3\n0")
        self.bill_right = Label(text=str_fee,font=(font_name,16),background='#F2F2F2',anchor="e")
        self.bill_right.place(x=240,y=83,width=180)
        self.bill_right["justify"]="right"
        #total
        self.total_left = Label(text="Total:",font=(font_name,20,"bold"),background='#F2F2F2',anchor="w")
        self.total_left.place(x=60,y=170,width=180)
        self.total_left["justify"]="left"
        #total_bill = amount+service_fee-discount
        total_bill = 33.99
        self.total_right = Label(text=str(total_bill),font=(font_name,20,"bold"),background='#F2F2F2',anchor="e")
        ...
        self.mainblock=Label(image=self.payblock3,background='#FFF')
        self.mainblock.place(x=40,y=256)
        #choose button image
        self.photoSelect_T="../image_components/defect-choise-T.png"
        self.photoSelect_T = PhotoImage(file=self.photoSelect_T)
        self.photoSelect_F="../image_components/defect-choise-F.png"
        self.photoSelect_F = PhotoImage(file=self.photoSelect_F)
        self.photoSelect_T="../image_components/defect-choise-T.png"
        self.photoSelect_T = PhotoImage(file=self.photoSelect_T)
        self.have_choose = 0
        #use credits
        self.creditlabel = Label(text="Use your credits",font=(font_name,14),background='#F2F2F2',anchor="e")
        self.creditlabel.place(x=75,y=292)
        self.explainlabel = Label(text="(100credits=1GBP)",font=(2),background='#F2F2F2',anchor="e")
        ...
        self.credit_str ="credits:"+str(self.credit_use)+"/"+str(self.credit_current)
        if self.credit_current>=self.credit_use:
            self.strcreditlabel = Label(text=self.credit_str,font=(font_name,14),background='#F2F2F2',anchor="e",fg='#33AF4E')
        else:
            self.strcreditlabel = Label(text=self.credit_str+"(Not enough)",font=(font_name,14),background='#F2F2F2',anchor="e",fg='red')
        ...
        #use cards
        self.cardlabel = Label(text="Use a bank card",font=(font_name,14),background='#F2F2F2',anchor="e")
        ...
        self.addcard_button = Button(image=self.addcard,background='#F2F2F2',borderwidth=0,compound=TOP,command=self.turnto_addcard)
        ...
        self.card_roller = tkinter.ttk.Combobox(textvariable=val,values=card,state="readonly",font=(font_name,14))
        ...
        self.pay_button = Button(image=self.photopay,background='#FFF',borderwidth=0,compound=TOP,command=self.turnto_payresult)
        ...
        self.back_button = Button(image=self.photoback,background='#FFF',borderwidth=0,compound=TOP,command=self.to_form_page)
        self.back_button.place(x=279,y=720)



if __name__ == '__main__':
    page = pay_access_Screen()
    page.mainloop()