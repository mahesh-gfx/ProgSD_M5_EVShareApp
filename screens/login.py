...
class login_page(tk.Frame):
    ...
    def __init__(self, container, controller):
        ...
        self.email_entry = Entry(self, font=(
            'Helvetica', 15), highlightthickness=0, background='white')
        ...
        self.password_entry = Entry(self, width=60, font=(
            'Helvetica', 15), highlightthickness=0, show="*", background='white')
        ...
        self.buttonSign = Button(self, image=self.SignBtnPath, compound=TOP, command=lambda: controller.change_frame(
            'register'), borderwidth=0, background='white', activebackground="#FFFFFF")
        ...
        self.buttonLogin = Button(self, image=self.LoginBtnPath, compound=TOP, command=self.handle_login,
                                  borderwidth=0, background='white', activebackground="#FFFFFF")
