...
class pay_bill_Screen(Tk):
    ...
    def __init__(self):
        ...
        self.buttonProf = Button(self,image=self.photoProf, compound=TOP, command=self.to_profile_page, borderwidth=0, background='#FFF')
        ...
        self.block1 = Label(image=self.payblock1, background='#FFF')
        self.block1.place(x=40, y=139)
        self.block2 = Label(image=self.payblock1, background='#FFF')
        self.block2.place(x=40, y=271)
        self.block3 = Label(image=self.payblock1, background='#FFF')
        self.block3.place(x=40, y=403)
        self.block4 = Label(image=self.payblock1, background='#FFF')
        self.block4.place(x=40, y=535)

        # text 1: tatal time + distance
        self.label1_left = Label(text="total time:\ntotal distance:", font=(font_name, 14), background='#D9D9D9', anchor="w")
        ...
        """
        str_fee = str("50\n3\n0")
        self.label2_right = Label(text=str_fee, font=(font_name, 14), background='#D9D9D9', anchor="e")
        self.label2_right.place(x=240, y=290, width=180)
        self.label2_right["justify"] = "right"

        # text 3: discount choice
        self.label3 = Label(text="Dsicount:", font=(font_name, 14), background='#D9D9D9', anchor="w")
        self.label3.place(x=60, y=410)
        self.label3["justify"] = "left"
        # enter dicount number
        self.disountlabel = Entry(text="", font=(font_name, 14), background="#D9D9D9", relief="solid")
        ...
        self.button_enterdiscount = Button(image=self.enter_discount, command=self.get_discount, borderwidth=0, background="#D9D9D9")
        self.button_enterdiscount.place(x=360, y=446)

        # text 4: membership
        self.label4 = Label(text="Membership:", font=(font_name, 14), background='#D9D9D9', anchor="w")
        ...
        self.membership_roller = tkinter.ttk.Combobox(textvariable=self.val, values=membership, state="readonly",
                                                font=(font_name, 14))
        ...
        self.button_entermembership = Button(image=self.enter_membership, command=self.get_membership, borderwidth=0, background="#D9D9D9")
        self.button_entermembership.place(x=360, y=578)
        # Ground part
        self.paybill_groundblock_file = r"../image_components/paybill_groundblock.png"
        self.paybill_groundblock = PhotoImage(file=self.paybill_groundblock_file)
        self.groundblock = Label(image=self.paybill_groundblock, background='#D9D9D9')
        self.groundblock.place(y=667)
        # Text for total fee
        self.label5_left = Label(text="Total:", font=(font_name, 24, "bold"), background='#D9D9D9', anchor="w", fg="#33AF4E")
        ...
        '''
        str_total = "29.9"
        self.label5_right = Label(text=str_total, font=(font_name, 24, "bold"), background='#D9D9D9', anchor="w", fg="#33AF4E")
        self.label5_right.place(x=130, y=673)
        # pay button
        self.filepay = r"../image_components/pay_big.png"
        self.photopay = PhotoImage(file=self.filepay)
        self.pay_button = Button(image=self.photopay, background='#D9D9D9', borderwidth=0, compound=TOP, command=self.turnto_payaccess)
        ...
        self.toplabel = Label(image=self.tophoto, borderwidth=0)
