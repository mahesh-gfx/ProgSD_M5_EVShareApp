...
class add_card_Screen(Tk):
    ...
    def __init__(self):
        ...
        self.buttonConsult = Button(image=self.photoConsult, compound=TOP,
        ...
        self.buttonForm = Button(image=self.photoForm, compound=TOP,
                                 command=self.to_form_page, borderwidth=0, background='#FFF')
        ...
        self.tittle = Label(image=self.tittlephoto,
                            borderwidth=0, background="#FFF")
        ...
        self.mainlabel = Label(image=self.mainblock,
                               borderwidth=0, background="#FFF")
        self.mainlabel.place(x=40, y=210)
        # 4 text for details
        # card number
        self.enternumber = Entry(font=(font_name, 14),
        ...
        self.save_button = Button(
            image=self.photosave, background='#FFF', borderwidth=0, compound=TOP, command=self.save)
